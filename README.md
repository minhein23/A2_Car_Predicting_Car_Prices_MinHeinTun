...
📦 A2 - Predicting Car Prices
│── 📂 Flask App
│   ├── 📂 model               # ML models & scaler
│   │   ├── A1_model.pkl       # Old Model (A1)
│   │   ├── A2_model.pkl       # New Model (A2)
│   │   ├── scaler.pkl         # Scaler for preprocessing
│   ├── 📂 templates           # HTML files
│   │   ├── index.html         # Homepage
│   │   ├── old_model.html     # Page for A1 Model
│   │   ├── new_model.html     # Page for A2 Model
│   ├── app.py                 # Flask application
│   ├── requirements.txt       # Python dependencies
│   ├── Dockerfile             # Docker setup
│   ├── README.md              # Project Documentation
│── 📂 ML Training
│   ├── model.py               # Model Classes (Optional)
│── 📂 Deployment
